...
- [Recursos IA](#recursos-ia)
  - [Buscadores de IAs disponibles](#buscadores-de-ias-disponibles)
  - [Portales de modelos disponibles](#portales-de-modelos-disponibles)
  - [Listado de IAs](#listado-de-ias)
    - [Para imagenes](#para-imagenes)
    - [Para sonido/audio](#para-sonidoaudio)
      - [Crear música](#crear-música)
      - [Convertir de audio a texto](#convertir-de-audio-a-texto)
    - [Para video](#para-video)
      - [Crear videos](#crear-videos)





## Buscadores de IAs disponibles
...
* [Playground](https://www.playground.com)
